    ...
    PROCESS {
        ...
        if ($canConnect) {
            try {
                ...
                $responseHeaders = Invoke-WebRequest -Uri $targetUri.AbsoluteUri -MaximumRedirection 0 -SkipCertificateCheck -SkipHttpErrorCheck -ErrorAction Stop | Select-Object -ExpandProperty Headers -ErrorAction Stop
